    ...
    this.configDatePicker = function(t) {
        ...
        function(t, n, o, a) {
            ...
            function d(e) {
                ...
                u.monthsList = [], u.mainObj.monthsList && 12 === u.mainObj.monthsList.length ? u.monthsList = u.mainObj.monthsList : u.monthsList = a.monthsList, u.yearsList = a.getYearsList(u.mainObj.from, u.mainObj.to), u.dayList = [];
                var o, c;
                ...
                r = 0 > r ? 6 : r;
                for (var l = 0; r > l; l++) u.dayList.unshift({});
                u.rows = [0, 7, 14, 21, 28, 35], u.cols = [0, 1, 2, 3, 4, 5, 6], u.currentMonth = u.mainObj.monthsList[e.getMonth()], u.currentYear = e.getFullYear().toString(), u.currentMonthSelected = angular.copy(u.currentMonth), u.currentYearSelected = angular.copy(u.currentYear), u.numColumns = 7
            }
